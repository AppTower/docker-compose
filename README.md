...
# What is this
  ...
  A dockerlized docker-compose image for ARM/v7. It is built from Raspberry Pi 3.
...
```
$ sudo curl -L --fail https://github.com/AppTower/docker-compose/releases/download/1.25.0/run.sh -o /usr/local/bin/docker-compose
